...
<!-- jvectormap -->
<script src="<?php echo base_url(); ?>application/assets/vendor/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>

<script src="<?php echo base_url(); ?>application/assets/vendor/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

<!-- jQuery Knob Chart -->
<script src="<?php echo base_url(); ?>application/assets/vendor/knob/jquery.knob.js"></script>
<!-- SweetAlert -->
<script src="<?php echo base_url(); ?>application/assets/vendor/sweetalert/dist/sweetalert.min.js"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
<script src="<?php echo base_url(); ?>application/assets/vendor/daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?php echo base_url(); ?>application/assets/vendor/datepicker/bootstrap-datepicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url(); ?>application/assets/vendor/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="<?php echo base_url(); ?>application/assets/vendor/slimScroll/jquery.slimscroll.min.js"></script>
<!-- ChartJS 1.0.1 -->
