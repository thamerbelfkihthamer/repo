<!-- Modal -->
<div class="modal fade" id="myModalacces" role="dialog" ng-app="modelview">
    <div class="modal-dialog" ng-controller="myController">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title text-center">Ajouter type d'acces model </h4>
            </div>
            <div class="modal-body">
                ...
                <input type="number" id="serveurid" ng-model="serveuridd">
            </div>
