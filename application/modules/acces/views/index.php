                ...
                <div class="box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="pull-right">
                                    <a href="<?php echo site_url('Acces/create') ?>">
                    ...
                    <div class="box-body">
                        <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                            <form method="get" action="<?php echo site_url('Acces/index') ?>">
                                <div class="row">
                                    <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="dataTables_info" id="example1_info" role="status" aria-live="polite">
                                        Présentation  <?php echo  $start?> à <?php   echo ($limit > count($Acces)) ? count($Acces) : $limit;?> de <?php echo  count($Acces)?> entrées
                                    </div>
                                </div>
                                <div class="col-sm-7">
                                    <?php if (count($Acces)) { ?>
